...
func TestVpcEgressgatewayNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vpcs.Egressgateways.New(
		context.TODO(),
		"vpcName",
...
func TestVpcEgressgatewayGet(t *testing.T) {
	...
	_, err := client.Vpcs.Egressgateways.Get(
		context.TODO(),
		"gatewayName",
		blaxel.VpcEgressgatewayGetParams{
			VpcName: "vpcName",
		},
	)
	if err != nil {
...
func TestVpcEgressgatewayList(t *testing.T) {
	...
	_, err := client.Vpcs.Egressgateways.List(context.TODO(), "vpcName")
	if err != nil {
		var apierr *blaxel.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestVpcEgressgatewayDelete(t *testing.T) {
	...
	_, err := client.Vpcs.Egressgateways.Delete(
		context.TODO(),
		"gatewayName",
		blaxel.VpcEgressgatewayDeleteParams{
			VpcName: "vpcName",
		},
	)
	if err != nil {
