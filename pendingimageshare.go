...
// opportunistically.
func (r *PendingImageShareService) List(ctx context.Context, query PendingImageShareListParams, opts ...option.RequestOption) (res *[]PendingImageShareListResponse, err error) {
...
func (r *PendingImageShareService) Accept(ctx context.Context, pendingShareID string, body PendingImageShareAcceptParams, opts ...option.RequestOption) (res *Image, err error) {
	opts = slices.Concat(r.Options, opts)
	if pendingShareID == "" {
...
// target workspace.
func (r *PendingImageShareService) Decline(ctx context.Context, pendingShareID string, opts ...option.RequestOption) (err error) {
	opts = slices.Concat(r.Options, opts)
...
type PendingImageShareListResponse struct {
...
func (r PendingImageShareListResponse) RawJSON() string { return r.JSON.raw }
func (r *PendingImageShareListResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type PendingImageShareListParams struct {
	// Direction of pending shares: "incoming" (default) or "outgoing"
	//
	// Any of "incoming", "outgoing".
	Direction PendingImageShareListParamsDirection `query:"direction,omitzero" json:"-"`
	paramObj
}

// URLQuery serializes [PendingImageShareListParams]'s query parameters as
// `url.Values`.
func (r PendingImageShareListParams) URLQuery() (v url.Values, err error) {
...
// Direction of pending shares: "incoming" (default) or "outgoing"
type PendingImageShareListParamsDirection string

const (
	PendingImageShareListParamsDirectionIncoming PendingImageShareListParamsDirection = "incoming"
	PendingImageShareListParamsDirectionOutgoing PendingImageShareListParamsDirection = "outgoing"
)

type PendingImageShareAcceptParams struct {
...
// URLQuery serializes [PendingImageShareAcceptParams]'s query parameters as
// `url.Values`.
func (r PendingImageShareAcceptParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
