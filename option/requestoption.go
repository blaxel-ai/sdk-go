...
// RequestOption is an option for the requests made by the blaxel API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/blaxel-ai/sdk-go#readme-requestoptions
...
// Optionally accepts a custom header name (defaults to "Authorization").
