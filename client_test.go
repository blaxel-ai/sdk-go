...
func TestUserAgentHeader(t *testing.T) {
	...
	if userAgent != fmt.Sprintf("Blaxel/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Sandboxes.List(context.Background(), blaxel.SandboxListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Sandboxes.List(cancelCtx, blaxel.SandboxListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Sandboxes.List(deadlineCtx, blaxel.SandboxListParams{})
		if err == nil {
