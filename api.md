...
- <code title="post /image-shares/pending/{pendingShareId}/accept">client.ImageShares.Pending.<a href="https://pkg.go.dev/github.com/blaxel-ai/sdk-go#ImageSharePendingService.Accept">Accept</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, pendingShareID <a href="https://pkg.go.dev/builtin#string">string</a>) (\*<a href="https://pkg.go.dev/github.com/blaxel-ai/sdk-go">blaxel</a>.<a href="https://pkg.go.dev/github.com/blaxel-ai/sdk-go#Image">Image</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
