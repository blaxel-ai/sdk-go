...
func TestSandboxFilesystemContentSearchWithOptionalParams(t *testing.T) {
	...
	_, err := client.Sandboxes.Filesystem.ContentSearch(
		context.TODO(),
		"filePath",
		blaxel.SandboxFilesystemContentSearchParams{
			Query:         "query",
			CaseSensitive: blaxel.Bool(true),
			ExcludeDirs:   blaxel.String("excludeDirs"),
...
func TestSandboxFilesystemDeleteTreeWithOptionalParams(t *testing.T) {
	...
	_, err := client.Sandboxes.Filesystem.DeleteTree(
		context.TODO(),
		"filePath",
		blaxel.SandboxFilesystemDeleteTreeParams{
			Recursive: blaxel.Bool(true),
		},
	)
	if err != nil {
...
func TestSandboxFilesystemFindWithOptionalParams(t *testing.T) {
	...
	_, err := client.Sandboxes.Filesystem.Find(
		context.TODO(),
		"filePath",
		blaxel.SandboxFilesystemFindParams{
			ExcludeDirs:   blaxel.String("excludeDirs"),
			ExcludeHidden: blaxel.Bool(true),
			MaxResults:    blaxel.Int(0),
...
func TestSandboxFilesystemSearchWithOptionalParams(t *testing.T) {
	...
	_, err := client.Sandboxes.Filesystem.Search(
		context.TODO(),
		"filePath",
		blaxel.SandboxFilesystemSearchParams{
			ExcludeDirs:   blaxel.String("excludeDirs"),
			ExcludeHidden: blaxel.Bool(true),
			MaxResults:    blaxel.Int(0),
			Patterns:      blaxel.String("patterns"),
...
func TestSandboxFilesystemWriteWithOptionalParams(t *testing.T) {
	...
	_, err := client.Sandboxes.Filesystem.Write(
		context.TODO(),
		"filePath",
		blaxel.SandboxFilesystemWriteParams{
			FilesystemWriteRequest: blaxel.FilesystemWriteRequestParam{
...
func TestSandboxFilesystemWriteTreeWithOptionalParams(t *testing.T) {
	...
	_, err := client.Sandboxes.Filesystem.WriteTree(
		context.TODO(),
		"filePath",
		blaxel.SandboxFilesystemWriteTreeParams{
			TreeRequest: blaxel.TreeRequestParam{
