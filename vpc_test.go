...
func TestVpcNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vpcs.New(context.TODO(), blaxel.VpcNewParams{
...
func TestVpcGet(t *testing.T) {
	...
	_, err := client.Vpcs.Get(context.TODO(), "vpcName")
	if err != nil {
		var apierr *blaxel.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestVpcDelete(t *testing.T) {
	...
	_, err := client.Vpcs.Delete(context.TODO(), "vpcName")
	if err != nil {
		var apierr *blaxel.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
